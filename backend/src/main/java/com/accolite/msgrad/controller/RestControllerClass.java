...
public class RestControllerClass 
{
	...
	@RequestMapping(value="setPassword",method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public int setPassword(@RequestBody Login login) throws Exception
	{
		System.out.println(login.getUsername()+" "+login.getPass_word());
		userdao.setPassword(login);
		return 1;
	}
	
	@RequestMapping(value="googlelogin",method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public User checklogin(@RequestBody GoogleLogin login)
	{
		System.out.println(login.getEmail());
		return userdao.googlelogin(login);
	}
	...
	public String passwordRecovery(@RequestBody PasswordRecoveryDto passwordRecovery) {
		...
		System.out.println(passwordRecovery.getOtp());
		return passwordRecovery.getOtp();
	}
}
